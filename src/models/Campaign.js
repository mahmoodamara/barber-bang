...
const campaignSchema = new Schema(
  {
    ...
    // Deterministic selection: lower priority wins, ties broken by higher discount then createdAt desc
    priority: { type: Number, default: 100, min: 0 },
    // stackable: false means only this campaign can apply (prevents stacking with offers if extended)
 ...
 * ✅ Indexes
 */
campaignSchema.index({ isActive: 1, priority: 1, createdAt: -1 });
